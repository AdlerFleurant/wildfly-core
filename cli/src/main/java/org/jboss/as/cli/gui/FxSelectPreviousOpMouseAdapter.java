 ...
 */
public class FxSelectPreviousOpMouseAdapter extends MouseAdapter implements ClipboardOwner {
    private FxCliGuiContext cliGuiCtx;
    private CLIOutput output;
    private FxDoOperationActionListener opListener;
    private Clipboard systemClipboard = Toolkit.getDefaultToolkit().getSystemClipboard();

    public FxSelectPreviousOpMouseAdapter(FxCliGuiContext cliGuiCtx, FxDoOperationActionListener opListener) {
